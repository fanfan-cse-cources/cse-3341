...
class Scanner {
                        ...
                        switch (this.token.toString()) {
                            ...
                            default: {
                                ...
                                // Handle the case of constant less than 1024
                                        ...
                                        && Integer.parseInt(this.token.toString()) < 1024) {
                                    this.t = Core.CONST;
                                }
                                // Handle cases of all the invalid input including invalid symbols, leading
                                // zeros, identifier with digit 0, constant greater than 1023 and etc.
                                else {
                                    throw new Exception();
                                }
    ...
    public void addSet(String e) {
        set.add(e);
    }

    public boolean inSet(String e) {
        return set.contains(e);
    }

    public void checkKeyword(Core x, String r) {

        if (x != this.currentToken()) {
            System.err.println("Error: No " + x.toString() + " keyword found in " + r + " statement around "
                    + this.currentToken() + ".");
//            System.exit(1);
        }
